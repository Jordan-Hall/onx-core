...
[The current configurable options (and its parse method) can be found here](https://github.com/Jordan-Hall/onx-core/blob/master/packages/nx/src/utils/params.ts). You would need a basic knowledge of TypeScript to read this.
