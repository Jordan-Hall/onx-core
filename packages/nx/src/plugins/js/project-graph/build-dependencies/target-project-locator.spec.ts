  ...
  describe('findTargetProjectWithImport (without tsconfig.json)', () => {
    ...
    beforeEach(() => {
      ...
      npmProjects = {
        ...
        /**
         * These @nxrc/nxrc-win32-x64-msvc external nodes have intentionally not had their locations on disk
         ...
         */
        'npm:@nxrc/nxrc-win32-x64-msvc@17.1.2': {
          type: 'npm',
          name: 'npm:@nxrc/nxrc-win32-x64-msvc@17.1.2',
          data: {
            version: '17.1.2',
            packageName: '@nxrc/nxrc-win32-x64-msvc',
            hash: 'sha512-oxKCKunuo4wRusMlNu7PlhBijhtNy7eBZPAWyqUsdfnb+CjY2QncjCguW3fnsG9gHQFCa+y0b1WkSkvJ5G1DiQ==',
          },
        },
        'npm:@nxrc/nxrc-win32-x64-msvc': {
          type: 'npm',
          name: 'npm:@nxrc/nxrc-win32-x64-msvc',
          data: {
    ...
    it('should fall back to matching external nodes from the graph if they could not be resolved on disk', () => {
      ...
      // We don't want to match npm:@nxrc/nxrc-win32-x64-msvc@17.1.2 in this fallback case even though it came first
      // in the external nodes list
      expect(result).toEqual('npm:@nxrc/nxrc-win32-x64-msvc');
    });
