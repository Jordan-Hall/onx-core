...
export function readCachedProjectGraph(): ProjectGraph {
  ...
  if (!projectGraphCache) {
    ...
    throw new Error(stripIndents`
      ...
      If you encounter this error as part of running standard \`nx\` commands then please open an issue on https://github.com/Jordan-Hall/nxrc
      ...
      if (e.internalDaemonError) {
        ...
        output.warn({
          ...
          bodyLines: [
            ...
            `Please file an issue at https://github.com/Jordan-Hall/nxrc`,
            'Nx Daemon is going to be disabled until you run "nx reset".',
          ],
        });
        markDaemonAsDisabled();
