  ...
  if (result.generalFailure) {
    ...
    messageLines.push(
      ...[
        ...
        '',
        verbose
          ? 'Please report the error at: https://github.com/Jordan-Hall/nxrc/issues/new/choose'
          : 'Please run with `--verbose` and report the error at: https://github.com/Jordan-Hall/nxrc/issues/new/choose',
      ]
    );
  }
